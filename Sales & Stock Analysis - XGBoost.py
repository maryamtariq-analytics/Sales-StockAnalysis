...
st.title('SALES & STOCK ANALYSIS')

st.header('*EXECUTIVE SUMMARY:*', divider='orange' )
st.subheader('BUSINESS PROBLEM')
st.markdown("""
A grocery store is facing a supply chain issue. Groceries are highly perishable items. When overstocked, we're wasting 
money on excessive storage and waste, but when understocked, then we risk losing customers. They want to know how to 
better stock the items that they sell. Need to accurately predict the stock levels of products based on sales data and 
sensor data on an hourly basis in order to more intelligently procure products from the suppliers.
""")
...
- *Feature Engineering*
- *Model Experimentation* by using cross validation and grid search to determine best set of Model Hyperparameters.
...
st.image(r"C:\Users\maria\OneDrive\Desktop\DataSets\FORAGE\COGNIZANT\Task3\FeatureImportance.png")

###################################################################################################################
###################################################################################################################
st.header('RESULTS & RECOMMENDATIONS', divider='rainbow')
